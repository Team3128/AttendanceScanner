...
public class TotalAttendanceActivity extends Activity
{
	...
	private void setDateFilter()
	{
		...
		selectStartDateButton.setText(String.format("%d/%d/%d", startYear, startMonth, startDay));
		selectEndDateButton.setText(String.format("%d/%d/%d", endYear, endMonth, endDay));
